               ...
               <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li id = "ModuloSolicitudes" class="nav-item has-treeview menu-open" style="display: none;" >
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                      <a href="../../../../app/View/formulario/Solicitudes/CuadroGeneralDiario.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
    ...
    <div class="content">
      ...
      <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <div class="form-group" >
                <label for="Banco">Banco Comunal :</label>
                <SELECT name="Banco" id= "Banco" class="form-control select2bs4"  style="width: 300px; " lang="es">  
                </SELECT>
...
<script>
  ...
  function Restriccion(){
          ...
          $.ajax({url:"../../../CRUD/Solicitudes/Restriccion.php",
                  type:"POST",
                  dataType: "json",
                  data:{fecha : fecha }, 
  ...
  $("#Situacion").change( function() {
        if ($(this).val() == "C") {            
          ...
          $("#Banco").select2();      
            ...
            ajax: {
                url: '../../../CRUD/Solicitudes/BusquedaBancoComunal.php',
                dataType: 'json',
                type:'POST',
                delay: 250,
                data: function (data) {
  ...
  Checkbox.addEventListener('click', function() {
    ...
    if(Checkbox.checked) {
      ...
      $("#BancoEdit").select2({
        ...
        placeholder: 'Seleccionar Banco Comunal',
        ajax: {
          url: '../../../CRUD/Solicitudes/BusquedaBancoComunal_nom.php',
          dataType: 'json',
          type:'POST',
          delay: 250,
          data: function (data) {
