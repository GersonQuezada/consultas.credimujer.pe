         ...
         columns:
          [     
                {"data" : "Accion",
                  ...
                  var BotonRevertir = '<button type="button" id="BotonAgregarTabla" class="BotonAgregarTabla" onclick = "RevertirInsert(\''+row.FECHAPROCEBN+'___'+row.FECHACREDITO+'___'+row.CODSOCIA+'___'+row.NRODNI+'\',2);" id = "BotonEditar"><i class="fas fa-history"></i></button>'; 
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Insert de Socia Manual BD</h1>
          </div><!-- /.col -->
    ...
    <div class="content" >
      <form  class="form" action="" method="post" >
        ...
        <input type="text" id="NombreSocia1" name="NombreSocia1" >   
                   <label>  Region :</label>
          <SELECT name="ComboBoxRegion1" id= "ComboBoxRegion1">
        ...
        <button type="button" id = "Btn_Inserta_Socia_ManualBN" >Ejecutar</button><p><p>
