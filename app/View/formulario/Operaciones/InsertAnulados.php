  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Enviar Socias para Anular Credito</h1>
          </div><!-- /.col -->
    ...
    <div class="content" >
      <form  class="form" action="" method="post" >
        ...
        <label for="NombreSociaAnulado" style="font-family:Arial; color:black">Nombre Socia : </label>
        <input type="text" id="NombreSociaAnulado" name="NombreSociaAnulado" >   
          <label>  Region :</label>
          <SELECT name="ComboBoxRegionAnulado" id= "ComboBoxRegionAnulado">
        ...
        <button type="button" id = "Btn_Ejecutar_Anulados" >Ejecutar</button><p><p>
