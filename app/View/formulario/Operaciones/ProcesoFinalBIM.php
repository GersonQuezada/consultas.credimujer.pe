          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                    <a href="../../../../app/View/formulario/Operaciones/ProcesoFinalBim.php" class="nav-link active ">
                    <i class="far fa-dot-circle nav-icon"></i>
                    <p>Envio de BIM</p>
                    </a>
                    </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Proceso de BIM - Envio Final</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Proceso de BIM - Envio Final</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
              ...
              min="2019-01-01">   
                ...
                <!-- <div class = "col-lg-2"> -->
                  ...
                  <button type="button" class = "btn btn-info col-sm-1"  onCLick = "EjecutarProcesoBIMFinal();">Ejecutar</button>
