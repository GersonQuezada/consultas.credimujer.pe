        ...
        "language": {
         ...
         columns:
          [ 
                  ...
                  var botonEditar = '<button type="button" id = "BotonEditarTabla" class="BotonEditarTabla" onclick = "AbrirModal(\''+row.NRODNI+'___'+row.APELLIDOSNOMBRES+'___'+row.REGION+'___'+row.TIPODESEMBOLSO+'___'+row.MTOAPROBADO+'\');" id = "BotonEditar"><i class="fas fa-pencil-alt"></i></button><br><button type="button" id = "BotonEliminarTabla" class="BotonEliminarTabla" onclick = "EliminarSociaDJ(\''+row.NRODNI+'___'+row.APELLIDOSNOMBRES+'___'+row.REGION+'___'+row.TIPODESEMBOLSO+'___'+row.MTODESEMBOLSADO+'\');" id = "BotonEliminar"><i class="fas fa-user-slash"></i></button>';
                  return botonEditar;   
                  }
               },
                  {"data" : "REGION"},
        ...
        "language": {
         ...
         columns:
          [ 
                  {"data" : "Editar",
                  render: function ( data, type, row) { 
                  var botonEditar = '</button><br><button type="button" id = "BotonEliminarTabla" class="BotonEliminarTabla" onclick = "RevertirSociaDJ(\''+row.NRODNI+'___'+row.APELLIDOSNOMBRES+'___'+row.REGION+'___'+row.TIPODESEMBOLSO+'___'+row.MTODESEMBOLSADO+'\');" id = "BotonEliminar"><i class="fas fa-undo-alt"></i></button>';
                  return botonEditar;   
                  }
               },
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Declaraciones Juradas</h1>
          </div><!-- /.col -->
    ...
    <div class="content" >
      <form  class="form" method="post" >        
        ...
        <button type="button" id = "Boton_Modal_Revertir" style = "margin-left:  1300px;" >Revertir</button>
        <div> 
              <div class="row">
