          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../../../../app/View/formulario/Contabilidad/Regist_Cuent_Abono_socia.php" class="nav-link active">
                          <i class="far fa-dot-circle nav-icon"></i>
      ...
      <div class="col-md-6">
            ...
            <div class="card card-info">
              ...
              <form action="" method="post">
                ...
                <button type="button" class = "btn btn-info col-sm-3"  name = "resgitra" onClick = "Registro();" style="margin-top: 10px" >Registrar</button> 
                 <button type="button" class = "btn btn-info col-sm-3"  id = "search" onClick = "Buscar();"style="margin-top: 10px" >Buscar</button> 
...
<script type="text/javascript">
         $(function () {            
            var Controler ="../../../CRUD/Entidadfinanciera/EnlistarCuentaAbono.php";
