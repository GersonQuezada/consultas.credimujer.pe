        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
                ...
                <li id = "REPORTESCONTABILIDAD"  class="nav-item has-treeview menu-open"  style="display: none;">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../../../../app/View/reportes/Contabilidad_reportes/RecuperacionesTotal.php" class="nav-link active">
                          <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reportes de Recuperaciones Total</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="content">
      ...
      <div class="col-md-12">
       ...
       min="2019-01-01">
        ...
        <input type="date" id="fechafinal" name="fechafinal"    value="<?php echo date("Y-n-j"); ?>" 
       min="2019-01-01">       
          <button type="button" onclick="Btn_Ejecutar_Recupe_Total();" >Ejecutar</button>
