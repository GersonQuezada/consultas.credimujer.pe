        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
                ...
                <li id = "REPORTESCONTABILIDAD"  class="nav-item has-treeview menu-open"  style="display: none;">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../../../../app/View/reportes/Contabilidad_reportes/ReportesMigrados.php" class="nav-link active">
                          <i class="far fa-dot-circle nav-icon"></i>
        ...
        <input type="date" id="fechafinMigra" name="fechafinMigra"  value="<?php echo date("Y-n-j"); ?>" 
              min="2019-01-01">     
                ...
                <label>Reportes :</label>
                       <SELECT name="tiporeporte" id= "ComboBoxMigra" class="custom-select form-control-border col-sm-6">
          ...
          <button type="button" onClick= "Btn_Ejecutar_ReporteConta_Migrado();" >Ejecutar</button><p>
