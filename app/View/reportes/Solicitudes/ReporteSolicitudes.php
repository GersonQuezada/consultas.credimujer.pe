               ...
               <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li id = "ModuloSolicitudes" class="nav-item has-treeview menu-open" style="display: none;" >
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                      <a href="../../../../app/View/reportes/Solicitudes/ReporteSolicitudes.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reportes de Solicitudes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      ...
      <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <input type="hidden" id="FechaProcesoCuadroDiario" class = "btn btn-default float" name="fechaProceso"  value="<?php echo date("d-m-Y"); ?>" > 
              <div class="row">
              <div class = "form-group">
              <label for="fechaInicio1" style=" font-family:Arial; color:black">Fecha de Inicio - Solicitado : </label>
              <input type="date" id="fechaInicio1" name="fechaInicio1"  class = "btn btn-default float" value="<?php echo date("Y-n-j"); ?>" min="2019-01-01">    
              <label for="fechafin1" style="   font-family:Arial; color:black ">Fecha Final - Solicitado : </label>
              <input type="date" id="fechafin1" name="fechafin1" class = "btn btn-default float" value="<?php echo date("Y-n-j"); ?>"  min="2019-01-01">
              <label for="MESAÑO1" style="  font-family:Arial; color:black">Mes: </label>    
              <input type="month" id="MESAÑO" class = "btn btn-default float" name="MESAÑO">  
              <label for="fechaInicio2" style=" font-family:Arial; color:black">Fecha de Inicio - Ejecutado : </label>
              <input type="date" id="fechaInicio2" name="fechaInicio2"  class = "btn btn-default float" value="<?php echo date("Y-n-j"); ?>"  min="2019-01-01">   
              </div>
              <div class = "form-group">

              <label for="fechafin2" style="   font-family:Arial; color:black ">Fecha Final - Ejecutado : </label>
              <input type="date" id="fechafin2" name="fechafin2" class = "btn btn-default float"  value="<?php echo date("Y-n-j"); ?>"  min="2019-01-01">                       
...
<script src="../../../../app/js/jsReporte/ComportamientoSolicitudes.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
<!-- jQuery -->
