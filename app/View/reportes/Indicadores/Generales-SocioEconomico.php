                  ...
                  <li id = "REPORTESINDICADORES" style="display: none;" class="nav-item has-treeview menu-open"   >
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview  menu-open">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item" >
                            <a href="../../../../app/View/reportes/Indicadores/Generales-SocioEconomico.php" class="nav-link active  ">
                              <i class="far fa-dot-circle nav-icon"></i>
                              <p>Socio economico</p>
                            </a>
                          </li>     
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="col-md-12">
          ...
          <OPTION value="0">Seleccionar</OPTION>
          <OPTION value="1">01- REPORTE DE CONTROL DE SOCIAS POR ACTIVIDAD ECONOMICA Y ZONIFICACION</OPTION>
          <OPTION value="2">02- INDICADORES DE GESTIÓN RURAL / URBANO</OPTION> 
          </SELECT>          

          <button type="button" class = "btn btn-info col-sm-1" onClick = "ReportesIndicadores3();" id = "Btn_Ejecutar_ReportesIndicadores" >Ejecutar</button>
...
<script src="../../../../app/js/jsReporte/ReporteIndicadores3.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
<!-- jQuery -->
