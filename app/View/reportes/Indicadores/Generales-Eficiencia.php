                  ...
                  <li id = "REPORTESINDICADORES" style="display: none;" class="nav-item has-treeview menu-open"   >
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview  menu-open">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item" >
                            <a href="../../../../app/View/reportes/Indicadores/Generales-Eficiencia.php" class="nav-link active  ">
                              <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="col-md-12">
          ...
          <button type="button" class = "btn btn-info col-sm-1" onClick = "ReportesIndicadores2();" id = "Btn_Ejecutar_ReportesIndicadores" >Ejecutar</button>
             ...
             <div class = "card">
              <div class="card-body">                 
                <div id= "div-content-data--1" class="table-responsive" style="margin-top: 20px">         
                      ...
                      <table id="report05" class="table table-striped table-bordered table-hover" cellspacing="0" style="display: none;">
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODSUCURSAL_ASOC</th>
                          <th>TIPOPRODUCTO</th>  
                          <th>AGRUPADO</th>  
                      ...
                      <table id="report06" class="table table-striped table-bordered table-hover"  cellspacing="0" style="display: none;">
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODSUCURSAL_CRE</th>
                          <th>CODASOCIACION</th>  
                          <th>TIPOASOCIACION</th>  
...
<script src="../../../../app/js/jsReporte/ReporteIndicadores2.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
<!-- jQuery -->
