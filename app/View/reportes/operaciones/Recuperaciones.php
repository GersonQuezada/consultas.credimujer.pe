...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content" >
      <form >
        <label for="fechaInicio1" style="font-family:Arial; color:black">Fecha de Inicio : </label>
        <input type="date" id="fechaInicio1" name="fechaInicio1"  value="<?php echo date("Y-n-j"); ?>" 
       min="2019-01-01">    
       <label for="fechafin1" style="font-family:Arial; color:black">Fecha Final : </label>
        <input type="date" id="fechafin1" name="fechafin1"  value="<?php echo date("Y-n-j"); ?>" 
              min="2019-01-01">  

          <button type="button" id = "Btn_Ejecutar_RECU" >Ejecutar</button>
          <div>
