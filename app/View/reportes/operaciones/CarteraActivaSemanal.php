  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes de Cartera Activa Semanal</h1>
          </div><!-- /.col -->
    ...
    <div class="content" >
      <form >
        <label for="fechaProceso" style="font-family:Arial; color:black">Fecha de Proceso : </label>
        <input type="date" id="fechaProceso" name="fechaProceso"  value="<?php echo date("Y-n-j"); ?>" 
       min="2019-01-01">       
          <button type="button" id = "Btn_Ejecutar_CAS" >Ejecutar</button>
          <div>
