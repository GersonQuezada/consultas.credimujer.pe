...
function RevertirProcesoBCP(){
        ...
        if(fecha.length == ""){
          ...
          // revierte proceso
           ...
           $.ajax({
              type:"POST",
              url:"../../../CRUD/Entidadfinanciera/RevertirProcesoBCP.php",
...
function GenerarArchivo(){
  ...
  if(Select.value == "CR"){ 
    $.ajax({
      type:"POST",
      url:"../../../CRUD/Entidadfinanciera/Generaciontxt.php",
      data:data, 
      dataType: "json",              
      success:function(data){  
...
function Listar(fecha,CODREGION){  
      var controller = "../../../CRUD/Entidadfinanciera/GeneraArchivoBcp.php";// URL
 ...
 function eliminarSocia(string){ 
      let  datos = string.split('___');
       ...
       Swal.fire({
              ...
              if (result.value) {
                $.ajax({url:"../../../CRUD//Entidadfinanciera/EliminaSociaEnvioBcp.php",
                  type:"POST",
                  dataType: "json",
...
function editarsocia(){
  ...
  text: 'Digite la llave' 
      ...
      if (result.value == "Credi2020") {
        console.log("ok");
        $.ajax({url:"../../../CRUD/Entidadfinanciera/EditaSociaDJCG.php",
                type:"POST",
                dataType: "json",
