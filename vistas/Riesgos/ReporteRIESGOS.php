        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reportes Riesgos</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content" >
      <div class="card card-info">
        ...
        <div class="card-body"> 
          ...
          <SELECT name="ComboBoxRegion" class="custom-select col-sm-1"  id= "ComboBoxRegion">
            <OPTION value="0">Seleccionar</OPTION>
          ...
          <label class="col-form-label" for="mtomayor" class="col-form-label">Monto Mayor</label>
          <input type="text" name="mtomayor" id = "mtomayor">
          <button type="button"  class="btn btn-info" id = "Btn_Ejecutar_ReportesRiesgo" >Ejecutar</button> 
        </div>
      </div>
