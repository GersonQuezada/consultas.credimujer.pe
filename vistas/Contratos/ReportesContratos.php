                ...
                <li class="nav-item has-treeview" style="display: none;"  id = "REPORTESCREDITOSPARALELOS" >
                 ...
                 <li id = "REPORTESOPERACIONES" class="nav-item has-treeview"  style="display: none;"  >
                  ...
                  <li class="nav-item has-treeview"  style="display: none;" id = "REPORTESCONTRATOS">
                    <a href="../../vistas/Contratos/ReportesContratos.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                       <p>
                          Reportes Contratos
                          <!-- <i class="right fas fa-angle-left"></i> -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes Contratos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Reportes Contratos</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
          <div class="form-group"> 
            ...
            <SELECT name="tiporeporte"  class="custom-select col-2" id= "ComboBox">
              ...
              <OPTION value="1">CUADRO - CONTROL DE CONTRATOS</OPTION>
              <OPTION value="2">REPORTE - CONTROL DE CONTRATOS</OPTION> 
            </SELECT>
            ...
            <button type="button" class="btn btn-info" id = "Btn_Ejecutar_ReportesContratos" >Ejecutar</button><p>
                    <div class="card">   
                    <div class="card-header">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                              <div id= "div-content-data--1" class="table-responsive" >        
                                <table id="report01" class="table table-striped table-bordered" cellspacing="0"  >
                                  <thead class="text-white bg-info text-center align-middle">             
                                    <th>nomsucursal_cre</th>
                                    <th>desasociacion</th>
                                    <th>desproducto</th>
                      ...
                      <div class="card-body" id="Reporte02_contenido" style="display: none">
                        <div class="row">
                          <div class="col-lg-12">
                              <div id= "div-content-data--1" class="table-responsive" >        
                                <table id="report02" class="table table-striped table-bordered" cellspacing="0"  >
                                  <thead class="text-white bg-info text-center align-middle">                  
                                    <th>CODREGION</th>
                                    <th>NOMBREREGION</th>
                                    <th>CODASOCIACION</th>
                                    ...
                                    <th>DESASOCIACION</th>
                                    <th>CICLO</th>
                                    <th>CODRESPONSABLE</th>
                                    <th>NOMRESPONSABLE</th>
                                    <th>DNIRESPONSABLE</th>
                                    <th>DOMICILIO</th>
                                    <th>MONTODESEMBOLSO</th>
                                    <th>MONTODEVUELTO</th>
                                    <th>MONTONETO</th>
...
<script src="../../dist/js/jsint/ReporteContratos.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
<!-- datatables JS -->
