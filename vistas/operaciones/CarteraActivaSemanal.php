              ...
              <li class="nav-item has-treeview" style="display: none;" id = "REPORTESSINFONED">
                ...
                <li class="nav-item has-treeview" style="display: none;"  id = "REPORTESCREDITOSPARALELOS" >
                 ...
                 <li id = "REPORTESOPERACIONES" class="nav-item has-treeview menu-open"  style="display: none;"  >
                          ...
                          <ul class="nav nav-treeview">
                            <li class="nav-item">
                              <a href="../../vistas/operaciones/CarteraActivaSemanal.php" class="nav-link active">
                                <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reporte Cartera Activa Semanal</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Reporte Cartera Activa Semanal</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          <div class="form-group">
            <label for="fechaProceso" class="col-form-label">Fecha de Proceso : </label>
            <input type="date" class="btn btn-default float col-sm-1.5" id="fechaProceso" name="fechaProceso"  value="<?php echo date("Y-n-j"); ?>"      min="2019-01-01">       
            <button type="button"  class="btn btn-info"  id = "Btn_Ejecutar_CAS" >Ejecutar</button>
                ...
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                        ...
                        <thead class="text-white bg-info text-center align-middle">                 
                          ...
                          <th>[NUMCREDITO_ASOC09]</th>
                          <th>[NUMCREDITO_SOCIA14]</th>
                          <th>[NUMCREDITO_ASOC14]</th>
                          <th>NombreRegion</th>
                          <th>Codigo Banco Comunal</th>
