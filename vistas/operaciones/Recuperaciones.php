              ...
              <li class="nav-item has-treeview" style="display: none;" id = "REPORTESSINFONED">
                ...
                <li class="nav-item has-treeview" style="display: none;"  id = "REPORTESCREDITOSPARALELOS" >
                 ...
                 <li id = "REPORTESOPERACIONES" class="nav-item has-treeview menu-open"  style="display: none;"  >
                          ...
                          <ul class="nav nav-treeview">
                            <li class="nav-item">
                              <a href="../../vistas/operaciones/Recuperaciones.php" class="nav-link active">
                                <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes de Recuperaciones</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Reportes de Recuperaciones</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content" >
      ...
      <div class="card-body">
        ...
        <div class="row-cols-6">      
          <label for="fechaInicio1" class="col-form-label">Fecha de Inicio : </label>
          <input type="date" class="btn btn-default float col-sm-2" id="fechaInicio1" name="fechaInicio1"  value="<?php echo date("Y-n-j"); ?>"    min="2019-01-01">    
          <label for="fechafin1" class="col-form-label">Fecha Final : </label>
          <input type="date" class="btn btn-default float col-sm-2" id="fechafin1" name="fechafin1"  value="<?php echo date("Y-n-j"); ?>"              min="2019-01-01">  
          <button type="button" class="btn btn-info" id = "Btn_Ejecutar_RECU" >Ejecutar</button>
        </div>
        <div class="card">
