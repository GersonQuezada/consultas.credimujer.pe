...
<div class="wrapper">
            ...
            <li id = "REPORTESCONTABILIDAD"  class="nav-item has-treeview"  style="display: none;">
              ...
              <li class="nav-item has-treeview" style="display: none;" id = "REPORTESSINFONED">
                ...
                <li class="nav-item has-treeview" style="display: none;"  id = "REPORTESCREDITOSPARALELOS" >
                      <a href="../../vistas/Creditos_Paralelos/ReporteCreditosParalelos.php" class="nav-link active">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes Creditos Paralelos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Reportes Creditos Paralelos</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="form-group"> 
            <div class="row-cols-12">
              ...
              <SELECT name="tiporeporte" class="custom-select col-3 "  id= "ComboBox">
                ...
                <OPTION value="1">CRÉDITOS PARALELOS - CARTERA ACTIVA</OPTION>
                <OPTION value="2">CRÉDITOS PARALELOS - DESEMBOLSOS</OPTION>
                <OPTION value="3">CRÉDITOS PROMOCIONALES - CARTERA ACTIVA</OPTION>
                <OPTION value="4">CRÉDITOS PROMOCIONALES - DESEMBOLSOS</OPTION>
                <OPTION value="5">CRÉDITOS PROMOCIONALES NUEVOS - CARTERA ACTIVA</OPTION>
                <OPTION value="6">CRÉDITOS PROMOCIONALES NUEVOS - DESEMBOLSOS</OPTION>
              </SELECT>
              ...
              <button type="button"  class="btn btn-info" id = "Btn_Ejecutar_ReportesParalelos" >Ejecutar</button>
            </div>
          </div>  
        </div>
      </div>
...
<script src="../../dist/js/jsint/ReporteCreditosParalelos.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
