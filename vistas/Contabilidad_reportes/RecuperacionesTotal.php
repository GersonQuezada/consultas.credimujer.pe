    ...
    <div class="sidebar">
      ...
      <li class="nav-item has-treeview menu-open">
            ...
            <li id = "REPORTESCONTABILIDAD"  class="nav-item has-treeview menu-open"  style="display: none;">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../../vistas/Contabilidad_reportes/RecuperacionesTotal.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes de Recuperaciones Total</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Reportes de Recuperaciones Total</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-info">
        ...
        <div class="form-group">
            ...
            <input class="btn btn-default float col-sm-2" type="date" id="fechaInicio" name="fechaInicio"  value="<?php echo date("Y-n-j"); ?>" min="2019-01-01">
            <label for="fechafinal" class="col-form-label">Fecha de Final : </label>
            <input class="btn btn-default float col-sm-2" type="date" id="fechafinal" name="fechafinal"    value="<?php echo date("Y-n-j"); ?>" min="2019-01-01">       
            <button class="btn btn-info" type="button" id = "Btn_Ejecutar_Recupe_Total" >Ejecutar</button>
        ...
        <div class="card">
          ...
          <div class="card-body" id = "Reporte01-Contenido" style="display: block;">
          <div class="row">
                    <div class="col-lg-12">
                        <div id= "div-content-data--1" class="table-responsive" >        
                          <table id="Reporte01-tabla" class="table table-striped table-bordered" cellspacing="0">
                            <thead class="text-white bg-info text-center align-middle">                 
                            <th>AGENCIA</th>
                            <th>ENTIDAD BANCARIA</th>
                            <th>PRODUCTO</th>
                            <th>DESTALLE PRODUCTO</th>
                            <th>FECHA DE RECUP</th>
                            <th>NUMERO CREDITO</th>
                            <th>CICLO</th>
                            <th>CODIGO DE BANCO</th>
                            <th>NOMBRE BANCO COMUNAL</th>
                            <th>DNI CLIENTE</th>
                            <th>CODSOCIA</th>
