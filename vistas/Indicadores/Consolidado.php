              ...
              <li id = "REPORTESINDICADORES" style="display: none;" class="nav-item has-treeview menu-open"   >
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview menu-open  ">
                    ...
                    <ul class="nav nav-treeview"> 
                    <li class="nav-item">
                      <a href="../../vistas/Indicadores/Consolidado.php" class="nav-link active">
                        <i class="far fa-dot-circle nav-icon"></i>
                        <p>Consolidado</p>                      
                      </a>
                    </li>                  
  ...
  <div class="content-wrapper"> 
    ...
    <div class="card-header">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-info" id = "Btn_Ejecutar_ReportesConsolidado" >Ejecutar</button><p>
          <div>                         
             <!--  <div class="container"> -->
             <div class="card">
              <div class="card-header">
...
<script src="../../dist/js/jsint/ReporteConsolidado.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
