                ...
                <li id = "REPORTESINDICADORES" style="display: none;" class="nav-item has-treeview menu-open"   >
                  ...
                  <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item has-treeview  menu-open">
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item" >
                          <a href="../../vistas/Indicadores/Generales-Eficiencia.php" class="nav-link active ">
                            <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <label class="col-form-label"style=" font-family:Arial; color:black">Fecha de Inicio : </label>
          <input type="date" class="btn btn-default float col-sm-2" id="fechaInicio" name="fechaInicio" min="2019-01-01">    
          <label class="col-form-label" style="   font-family:Arial; color:black ">Fecha Final : </label>
          <input type="date" class="btn btn-default float col-sm-2" id="fechafin" name="fechafin"  min="2019-01-01">     
          <label class="col-form-label" style="  font-family:Arial; color:black">Mes: </label>    
          ...
          <div class="form-group">
          <label class="col-form-label"  style="  font-family:Arial; color:black">Indicadores :</label>
          <SELECT name="tipoindicadores"  class="col-5 custom-select " id= "tipoindicadores">
          <OPTION value="0">Seleccionar</OPTION>
          <OPTION value="1">01- REPORTE: CARTERA POR PROMOTORA POR PRODUCTIVIDAD Y REGIONES</OPTION>
          <OPTION value="2">02- CONTROL DEL NÚMERO DE ASOCIACIONES CREADAS A LA FECHA</OPTION>
          <OPTION value="3">03- CONTROL DE COLOCACIONES Y COLOCACIONES NUEVAS EN EL PERIODO</OPTION>
          <OPTION value="4">04- CONTROL DE ASOCIACIONES CREADOS, DE BAJA E INCOBRALES HASTA LA FECHA</OPTION>
          <OPTION value="5">05- CONTROL DE ASOCIACIONES CREADOS, DE BAJA E INCOBRABLES EN EL PERIODO</OPTION>
          <OPTION value="6">06- CONTROL DE ASOCIACIONES EN TRÁNSITO</OPTION>
          </SELECT>         

          <button type="button" class="btn btn-info" id = "Btn_Ejecutar_ReportesIndicadores" >Ejecutar</button>
          </div>
        <div class="card">
              <div class="card-header">
             ...
             <!--  <div class="container"> -->
             <div class="card-body" id="report01" style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report01-table"  class="table table-striped table-bordered" cellspacing="0" >
             ...
             <div class="card-body" id="report02" style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                  <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report02-table" class="table table-striped table-bordered" cellspacing="0">
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODSUCURSAL_ASOC</th>                
                          <th>TIPOPRODUCTO</th>                
                          <th>NROASOCIACIONES</th>                
                         </thead>
                      </table>                  
                  </div>
                </div>
             ...
             <div class="card-body" id="report03" style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                  <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report03-table"  class="table table-striped table-bordered" cellspacing="0" >
                         <thead class="text-white bg-info text-center align-middle">             
             ...
             <div class="card-body" id="report04" style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report04-table" class="table table-striped table-bordered" cellspacing="0"  >
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODSUCURSAL_ASOC</th>
                          <th>TIPOPRODUCTO</th>  
                          <th>ESTADO_DE_ASOC</th>  
                          <th>NRO_ASOC</th>                   
                         </thead>
                      </table>                  
                     </div>
             ...
             <div class="card-body" id="report05"  style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report05-table" class="table table-striped table-bordered" cellspacing="0"  >
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODSUCURSAL_ASOC</th>
                          <th>TIPOPRODUCTO</th>  
                          <th>AGRUPADO</th>  
             ...
             <div class="card-body"  id="report06"  style="display: none;">
              <div class="row">
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report06-table" class="table table-striped table-bordered" cellspacing="0">
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODSUCURSAL_CRE</th>
                          <th>CODASOCIACION</th>  
                          <th>TIPOASOCIACION</th>  
                          <th>DESASOCIACION</th> 
                          <th>FECHAULTDESEMBOLSO</th>  
                          <th>FECHASALIDA</th>                    
                         </thead>
                      </table>                  
                     </div>
...
<script src="../../dist/js/jsint/ReporteIndicadores2.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
