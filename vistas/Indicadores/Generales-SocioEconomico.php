              ...
              <li id = "REPORTESINDICADORES" style="display: none;" class="nav-item has-treeview menu-open"   >
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview menu-open ">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item" >
                        <a href="../../vistas/Indicadores/Generales-SocioEconomico.php" class="nav-link active">
                          <i class="far fa-dot-circle nav-icon"></i>
                          <p>Socio economico</p>
                        </a>
                      </li>     
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-info" id = "Btn_Ejecutar_ReportesIndicadores" >Ejecutar</button><p>
          </div>
          <div class="card">
              <div class="card-header">
...
<script src="../../dist/js/jsint/ReporteIndicadores3.js"></script>
