                ...
                <li id = "REPORTESINDICADORES" style="display: none;" class="nav-item has-treeview menu-open"   >
                  ...
                  <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item has-treeview menu-open ">
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="../../vistas/Indicadores/Generales-Crecimiento.php" class="nav-link active ">
                            <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <SELECT name="tipoindicadores"  class="col-8 custom-select " id= "tipoindicadores">
            <OPTION value="0">Seleccionar</OPTION>
          ...
          <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body" id="report01-Contenido" style="display: none;">
                <div class="row">
                    <div class="col-lg-12">
                        <div id= "div-content-data--1" class="table-responsive" >        
                          <table id="report01-Contenido-table"  class="table table-striped table-bordered" cellspacing="0">
              ...
              <div class="card-body" id="report01-Resumen" style="display: none;">
                <div class="row">
                  <div class="col-lg-12">
                      <div id= "div-content-data--1" class="table-responsive" >        
                        <table id="report01-Resumen-table"  class="table table-striped table-bordered" cellspacing="0" >
                          <thead class="text-white bg-info text-center align-middle">             
                            <th>TIPOPRODUCTO</th>
                            <th>NRO_COLOCACIONES</th>
                            <th>TOTAL_DSBS</th>
             ...
             <div class="card-body" id="report04-Contenido" style="display: none;" >
              <div class="row">
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report04-Contenido-table" class="table table-striped table-bordered" cellspacing="0" >
                         <thead class="text-white bg-info text-center align-middle">             
                          <th>CODAGENCIA_CRE</th>
                          <th>TIPOASOCIACION</th>
                          <th>NRO_CREDITOS</th>
             ...
             <div class="card-body" id="report04-Resumen" style="display: none;" >
              <div class="row">
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                      <table id="report04-Resumen-table" class="table table-striped table-bordered" cellspacing="0">
                         <thead class="text-white bg-info text-center align-middle">                          
                          <th>TIPOPRODUCTO</th>
                          <th>NROCREXASOC</th>
                          <th>NROCREXSOCIA</th>
...
<script src="../../dist/js/jsint/ReporteIndicadores.js"></script>
