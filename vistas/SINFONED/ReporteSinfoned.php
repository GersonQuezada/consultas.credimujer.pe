      ...
      <li class="nav-item has-treeview menu-open ">
            ...
            <li id = "REPORTESCONTABILIDAD"  class="nav-item has-treeview"  style="display: none;">
              ...
              <li class="nav-item has-treeview" style="display: none;" id = "REPORTESSINFONED">
                <a href="../../vistas/SINFONED/ReporteSinfoned.php" class="nav-link active ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Reportes Sinfoned
                  </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes Sinfoned</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Reportes Sinfoned</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
          <div class="form-group"> 
            <div class="row-cols-6">
              ...
              <SELECT name="tiporeporte" class="custom-select col-2 " id= "ComboBox">
                <OPTION value="0">Seleccionar</OPTION>
                <OPTION value="1">PLAZOS Y MONTOS</OPTION>
                <OPTION value="2">SECTOR ECONÓMICO</OPTION>
                <OPTION value="3">SEXO</OPTION>
              </SELECT> 
              <label for="tipocambio" class="col-form-label">Tipo Cambio</label>
              <input type="text" name="tipocambio" value="2.80" id = "tipocambio">             
              <button type="button" class="btn btn-info" id = "Btn_Ejecutar_ReportesSinfoned" >Ejecutar</button><p>
            </div>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <!--  <div class="container"> -->
                <div class="card-body" id="Reporte01_contenido" style="display: none">
                  <div class="row">
                    <div class="col-lg-12">
                        <div id= "div-content-data--1" class="table-responsive" >        
                          <table id="report01-tabla" class="table table-striped table-bordered" cellspacing="0" >
                            <thead class="text-white bg-info text-center align-middle">             
                              <th>TipoAsociacion</th>
                              <th>total</th>
                              <th>Sumatoria DSB</th>
                              <th>Desembolso 0-400</th>
                              <th>MtoDesembolso 0-400</th>
                              <th>Desembolso 401-1000</th>
                              <th>MtoDesembolso 401-1000</th>
                              <th>Desembolso 1001-3000</th>
                              <th>MtoDesembolso 1001-3000</th>
                              <th>Desembolso mayor a 3000</th>
                              <th>MtoDesembolso mayor a 3000</th>
                              <th>Plazos 0-4</th>
                              <th>MtoDesembolso 0-4</th>
                              <th>Plazos 5-12</th>
                              <th>MtoDesembolso 5-12</th>
                              <th>Plazos 13-24</th>
                              <th>MtoDesembolso 13-24</th>                
                              <th>Plazos mayor a 24</th>
                              <th>MtoDesembolso mayor a 24</th>
                            </thead>
                          </table>                  
                      </div>
                    </div>
                ...
                <div class="card-body" id="Reporte02_contenido" style="display: none;">
                  <div class="row">
                    <div class="col-lg-12">
                        <div id= "div-content-data--1" class="table-responsive" >        
                          <table id="report02-tabla" class="table table-striped table-bordered" cellspacing="0" >
                            <thead class="text-white bg-info text-center align-middle">             
                ...
                <div class="card-body" id="Reporte03_contenido" style="display: none;">
                  <div class="row">
                    <div class="col-lg-12">
                        <div id= "div-content-data--1" class="table-responsive" >        
                          <table id="report03-tabla" class="table table-striped table-bordered" cellspacing="0" >
                            <thead class="text-white bg-info text-center align-middle">             
                              <th>Sexo</th>
                              <th>Tipo Asociacion</th>  
                              <th>Moneda</th>  
...
<script src="../../dist/js/jsint/ReporteSinfoned.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
