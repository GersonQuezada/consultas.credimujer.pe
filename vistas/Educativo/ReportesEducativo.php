    ...
    <a href="../../Menu.php" class="brand-link">
      ...
      <li class="nav-item has-treeview menu-open" style="display: none;" id = "MODULOEDUCATIVO">
           ...
           <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              <li id = "AsitenciaTaller"  class="nav-item has-treeview"   >
                <a href="../../vistas/Educativo/ReportesEducativo.php" class="nav-link active">
                  <i class="nav-icon fas fa-circle"></i>
                  <p>
                    Reporte Educativo
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reportes Educativos</h1>
          </div><!-- /.col -->
    ...
    <div class="content" >
      <form >
        <label for="fechaInicio" style=" font-family:Arial; color:black">Año : </label>
        <input type="text" name="ano" id = "ano">    
        <label for="fechafin" style="   font-family:Arial; color:black ">Mes : </label>
        <input type="text" name="mes" id = "mes">    
        <label>Reportes :</label>
        <SELECT name="tiporeporte" id= "ComboBox">
        <OPTION value="0">Seleccionar</OPTION>
        <OPTION value="1">01- Cobertura Nivel Socia</OPTION>       
        </SELECT>
        <button type="button" id = "Btn_Ejecutar_ReportesEducativo" >Ejecutar</button><p>
        <div>                         
             <!--  <div class="container"> -->
...
<script src="../../dist/js/jsint/ReporteEducativo.js?v="<?php echo $_SESSION["Version_cod"]; ?>></script>
