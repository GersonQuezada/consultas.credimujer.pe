...
function Insertar(){
    ...
    if(fechaproceso == ""){
        ...
        $.ajax({url:"../../bd/OrdenPagos/InsertarOrdenPagos.php",
            type:"POST",
            dataType: "json",
...
function CambioSocia(string) {
    ...
    if(banco == 'BN'){
        ...
        $.ajax({
            type:"POST",
            url:"../../bd/Entidadfinanciera/BusquedaCuentaAbonoCombo.php",
    ...
    if(tipoOperacion == "TRANF"){
        ...
        $("#CampoSocia_"+Item+'_'+region+'_'+fecha).select2({
            placeholder: 'Seleccione una socia',
                ajax: {
                    url: '../../bd/OrdenPagos/BusquedaBancoComunal_socia.php',
                    dataType: 'json',
                    type:'POST',
                    delay: 250,
                    data: function (data) {
...
function GuardarOrdenesPagos(string) {
    ...
    if(TipoOperacion == "TRANF" ){
        if(TipoCredito == 0){
            ...
            NroCuenta = "";
            Celular = "";
            $.ajax({url:"../../bd/OrdenPagos/ModificarOrdenPago.php",
              type:"POST",
              dataType: "json",
...
function EliminarOrdenesPagos(string) {
    ...
    let item = datos[1];
    let region = datos[0];  
    $.ajax({url:"../../bd/OrdenPagos/EliminarOrdenPago.php",
        type:"POST",
        dataType: "json",
...
async function ConsultaSaldoPromotora(region,banco) {
    ...
    try {
        const response = await fetch('../../bd/OrdenPagos/BusquedaBancoComunal_saldo.php',
                        {method : 'post',                                                                                        
                        headers:new Headers({
...
function DesactivarModal(){
    ...
    var value = 'NO';
    $.ajax({url:"../../bd/OrdenPagos/EditarRestriccion.php",
            type:"POST",
            dataType: "json",
