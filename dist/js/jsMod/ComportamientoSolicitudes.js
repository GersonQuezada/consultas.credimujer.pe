"use strict";
function Listar(){  
  var Controler ="../../bd/Solicitudes/CuadroDiario.php";
...
function Insertar(){
   ...
   if(Region == 0){
    ...
    $.ajax({url:"../../bd/Solicitudes/InsertarSolicitud.php",
                  type:"POST",
                  dataType: "json",
...
function editarsocia(){
  ...
  $.ajax({url:"../../bd/Solicitudes/EditarSolicitud.php",
          type:"POST",
          dataType: "json",
 ...
 function eliminarSocia(string){ 
      ...
      let  datos = string.split('___');
       ...
       Swal.fire({
              ...
              if (result.value) {
                $.ajax({url:"../../bd/Solicitudes/EliminarSolicitud.php",
                  type:"POST",
                  datatype: "json",
...
function DesactivarModulo(){
  var fecha = document.getElementById('FechaProcesoCuadroDiario').value;
  var value = 'NO';
  $.ajax({url:".../../bd/Solicitudes/EditarRestriccion.php",
          type:"POST",
          dataType: "json",
