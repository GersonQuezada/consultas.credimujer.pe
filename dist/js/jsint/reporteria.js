$(document).on("click", "#Btn_Ejecutar", function (e){
  ...
  var nrocre = $("[name='NroCredito']").val();
   if(cbx == 1){         
        ...
        if(nrocre == ""){
          Swal.fire({type: 'error',title: 'Error!!',text: 'Debe ingresar un Nro de Credito'})
        }
        if(fecha2 < fecha1){
          Swal.fire({type: 'error',title: 'Error!!',text: 'Fecha de inicio no puede ser mayor a fecha final'})
        }else{ 
...
$(document).on("click", "#Btn_Ejecutar_Recupe_Total", function (e){ 
  var fecha1 = $("[name='fechaInicio']").val();
  var fecha2 = $("[name='fechafinal']").val();  
  Report_Recu_Total(fecha1,fecha2);
});

$(document).on("click", "#Btn_Ejecutar_ReporteConta_Migrado", function (e){
...
$("#ComboBoxMigra").change( function() {
        if ($(this).val() === "1") {
            ...
            document.getElementById("report01_Contenido").style.display = "block";
            document.getElementById("report02_Contenido").style.display = "none";
            document.getElementById("report03_Contenido").style.display = "none";
            document.getElementById("report04_Contenido").style.display = "none";     
        }else if ($(this).val() === "2") {
            ...
            document.getElementById("report01_Contenido").style.display = "none";
            document.getElementById("report02_Contenido").style.display = "block";
            document.getElementById("report03_Contenido").style.display = "none";
            document.getElementById("report04_Contenido").style.display = "none";           
        }else if ($(this).val() === "3") {
            $("#MESAÑO").prop("disabled", true);
            ...
            document.getElementById("report01_Contenido").style.display = "none";
            document.getElementById("report02_Contenido").style.display = "none";
            document.getElementById("report03_Contenido").style.display = "block";
            document.getElementById("report04_Contenido").style.display = "none";          
        }else if ($(this).val() === "4") {
            $("#MESAÑO").prop("disabled", true);
            $("#ComboBoxRegion").prop("disabled", true);
            ...
            document.getElementById("report02_Contenido").style.display = "none";
            document.getElementById("report03_Contenido").style.display = "none";
            document.getElementById("report04_Contenido").style.display = "block";           
        } else if ($(this).val() === "0") {         
            Cargar();
            document.getElementById("report01_Contenido").style.display = "none";
            document.getElementById("report02_Contenido").style.display = "none";
