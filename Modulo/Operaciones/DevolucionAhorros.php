...
<html lang="en">
<head>   
  <?php include 'Model_Devolucion_Ahorros_Bn.php' ?> 
  <meta charset="utf-8">
  ...
  <script type="text/javascript">
    ...
    function Listar(){  
     var Controler ="../../bd/Entidadfinanciera/ResumenSociasDevoluciones.php";
     var Nameexcel = "SociasResumeDevolucionesBN";

     var table = $("#TablaResumenDevoluciones")
        .DataTable({
          dom:  "<'row'<''f><''B><'' i>>rtp",
          paging:true,
          bLengthChange: false,
             ...
             <li id="ENTIDADBANCARIABN" class="nav-item has-treeview menu-open"  style="display: none;">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview menu-open  ">
                    ...
                    <ul class="nav nav-treeview">
                      <li id = "OPCIONDEVOLUCIONDEAHORROS" class="nav-item active" style="display: none;">
                        <a href="../../Modulo/Operaciones/DevolucionAhorros.php" class="nav-link  active">
                          <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content" >
      <form  class="form" method="post" >
        ...
        <label for="NombreSocia" style="font-family:Arial; color:black">Nombre Socia : </label>
        <input type="text" id="NombreSocia" name="NombreSocia" >   
                   <label>  Region :</label>
          <SELECT name="ComboBoxRegion" class="custom-select form-control-border col-sm-2" id= "ComboBoxRegion">
          ...
          <OPTION value="002">UCAYALI</OPTION>
           ...
           <label>  Entidad :</label>
          <SELECT name="ComboBoxTipo" class="custom-select form-control-border col-sm-2" id= "ComboBoxTipo">
          <OPTION value="0">Seleccionar</OPTION> 
          <OPTION value="2">Banco de la Nacion</OPTION>
          </SELECT>
        <button type="button" class = "btn btn-info col-sm-2"  id = "Btn_Ejecutar_Devolucion" >Ejecutar</button><p><p>
        ...
        <div>
             ...
             <!--  <div class="container"> -->
              ...
              <div class="row" style="margin-left:15px">
                ...
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                        <table id="TablaBN" class="table table-striped table-bordered" cellspacing="0" style="display: none;">
              ...
              <div class="row" style="margin-left:15px">
                ...
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                        <table id="TablaBIM" class="table table-striped table-bordered" cellspacing="0" style="display: none;">
                         <thead class="text-white bg-info text-center align-middle">
                         <th>Accion</th>
                         <th>Codigo Region</th>
                         <th>Nomb. Sucursal</th>
                         <th>Cod. Banco Comunal</th>
                         <th>Banco Comunal</th>
                         <th>Num Credito</th>
                         <th>Producto</th>
                         <th>Codigo Socia</th>
                         ...
                         <th>Monto Desembolsado</th>
                         <th>Fecha Envio</th> 
                         <th>Fecha a Desembolsar</th> 
                         <th>Fecha proceso BIM</th> 
                         <th>Tipo Cobro</th> 
                         <th>Carga a Enviar</th> 
                         </thead>
                         <tbody></tbody>
                       </table>                  
                     </div>
                ...
                <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                        <table id="TablaResumenDevoluciones" class="table table-striped table-bordered" cellspacing="0"  >
                         <thead class="text-white bg-info text-center align-middle"> 
                         <th>FECHAPROCEBN</th>
