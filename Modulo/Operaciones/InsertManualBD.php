...
<html lang="en">
<head>
   <?php include 'Model_Insert_Manual_Bn.php' ?> 
             ...
             <li id="ENTIDADBANCARIABN" class="nav-item has-treeview menu-open"  style="display: none;">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview menu-open ">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../../Modulo/Operaciones/InsertManualBD.php" class="nav-link  active ">
                          <i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Inserta Socia a la Base BN</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../Menu.php">Home</a></li>
              <li class="breadcrumb-item active">Inserta Socia a la Base BN</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      ...
      <form  class="form" action="" method="post" >
        ...
        <label for="NombreSocia1" style="font-family:Arial; color:black">Nombre Socia : </label>
        <input type="text"   id="NombreSocia1" name="NombreSocia1" >   
                   <label>  Region :</label>
          <SELECT class="custom-select form-control-border col-sm-2" name="ComboBoxRegion1" id= "ComboBoxRegion1">
        ...
        <button type="button" class="btn btn-info" id = "Btn_Inserta_Socia_ManualBN" >Ejecutar</button><p><p>

        <div class="col-lg-12">
                    <div id= "div-content-data--1" class="table-responsive" >        
                        <table id="TablaManualBN" class="table table-striped table-bordered" cellspacing="0"  >
        ...
        <div>
                  <div class="card ">
                      ...
                      <H5>Resumen del Dia</H5>
                        <div class="col-lg-12">
                            <div id= "div-content-data--1" class="table-responsive" >        
                                <table id="TablaManualBNResumen" class="table table-striped table-bordered" cellspacing="0"  >
                                <thead class="text-white bg-info text-center align-middle"> 
                                <th>Accion</th> 
                                <th>Fecha Envio</th>
                                <th>Tipo Desembolso</th> 
...
<script >
 ...
 function Listar(){  
  var Controler ="../../bd/Entidadfinanciera/ResumenSociasInsertados.php";
  var Nameexcel = "SociasResumeInsertadoBN";

  var table = $("#TablaManualBNResumen")
     .DataTable({
       dom:  "<'row'<''f><''B><'' i>>rtp",
       paging:true,
       bLengthChange: false,
      ...
      columns:
       [     
             {"data" : "Accion",
               ...
               var BotonRevertir = '<button type="button" id="BotonAgregarTabla" class="btn-danger" onclick = "RevertirInsert(\''+row.FECHAPROCEBN+'___'+row.FECHACREDITO+'___'+row.CODSOCIA+'___'+row.NRODNI+'\',2);" id = "BotonEditar"><i class="fas fa-history"></i></button>'; 
