...
<html lang="es">
<head>
    <?php include 'Model_DJ_Bn.php' ?> 
    <?php include 'Model_RevertirSocia.php' ?> 
    <meta charset="utf-8">
  ...
  <script type="text/javascript">
    ...
    function Listar(){  
     var Controler ="../../bd/Entidadfinanciera/ResumenEnvioBancoNacion.php";
     var Nameexcel = "SociasResumeBN";

     var table = $("#TablaResumenBN")
        .DataTable({
          dom:  "<'row'<''f><''B><'' i>>rtp",
          paging:true,
          pageLength: 6,
        ...
        "language": {
         ...
         columns:
          [ 
                  ...
                  var botonEditar = '<button type="button" id = "BotonEditarTabla" class="btn btn-info col-sm"   data-toggle="modal" data-target="#modalDJBN"  onclick = "AbrirModal(\''+row.NRODNI+'___'+row.APELLIDOSNOMBRES+'___'+row.REGION+'___'+row.TIPODESEMBOLSO+'___'+row.MTOAPROBADO+'\');" id = "BotonEditar"><i class="fas fa-pencil-alt"></i></button><br><button type="button" id = "BotonEliminarTabla"  class="btn btn-danger col-sm" onclick = "EliminarSociaDJ(\''+row.NRODNI+'___'+row.APELLIDOSNOMBRES+'___'+row.REGION+'___'+row.TIPODESEMBOLSO+'___'+row.MTODESEMBOLSADO+'\');" id = "BotonEliminar"><i class="fas fa-user-slash"></i></button>';
                  return botonEditar;   
                  }
                  },
                  {"data" : "REGION"},
    ...
    function ListarEliminadas(){  
     var Controler ="../../bd/Entidadfinanciera/ResumenEnvioBancoNacionEliminadas.php";
     var Nameexcel = "ResumenSociasEliminadas";

     var table = $("#ResumenSociasEliminadas")
        .DataTable({          
          pageLength: 5,
          paging:true,
          bLengthChange: false,
          ...
          columns: [ 
                  {"data" : "Editar",
                    render: function ( data, type, row) { 
                    var botonEditar = '</button><br><button type="button" id = "BotonEliminarTabla"  class="btn-danger" onclick = "RevertirSociaDJ(\''+row.NRODNI+'___'+row.APELLIDOSNOMBRES+'___'+row.TIPODESEMBOLSO+'___'+row.MTODESEMBOLSADO+'\');" id = "BotonEliminar"><i class="fas fa-undo-alt"></i></button>';
                    return botonEditar;   
                    }
                  },                   
                  {"data" : "DESASOCIACION"},               
                    ...
                    <li class="nav-item has-treeview menu-open  ">
                      ...
                      <ul class="nav nav-treeview">
                        <li id = "OPCIONDJ" class="nav-item" style="display: none;">
                          <a href="../../Modulo/Operaciones/DjBancoNacion.php" class="nav-link  active">
                            <i class="far fa-dot-circle nav-icon"></i>
      ...
      <div class="card">
        <div class="card-body">
          <form >        
            ...
            <button type="button" class = "btn btn-danger col-sm-2"  id = "Boton_Modal_Revertir" style = "margin-left:  1300px;" >Revertir</button>
            <div> 
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div id= "div-content-data--1" class="table-responsive" >        
                            <table id="TablaResumenBN" class="table table-striped table-bordered" cellspacing="0"  >
...
<!-- REQUIRED SCRIPTS -->
<script type="text/javascript">
  $(document).on("click", "#Boton_Modal_Revertir", function (e){
    $("#RevertirSocia").modal({backdrop: 'static', keyboard: false}); 
