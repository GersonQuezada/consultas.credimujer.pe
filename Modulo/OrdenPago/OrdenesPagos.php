        ...
        <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview ">
                ...
                <li id = "ModuloOrdenPagos" class="nav-item has-treeview menu-open" style="display: none" >
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                    <a href="../../Modulo/OrdenPago/OrdenesPagos.php" class="nav-link active">
                    <i class="far fa-dot-circle nav-icon"></i>
...
<!-- REQUIRED SCRIPTS -->
<script src="../../dist/js/jsMod/ComportamientoOrdenPago.js"></script> 
<!-- jQuery -->
...
<script>
  ...
  function Restriccion(){ 
    ...
    $.ajax({url:"../../bd/OrdenPagos/Restriccion.php",
            type:"POST",
            dataType: "json",
            data:{fecha : fecha }, 
  ...
  function Enlistar(){
    var controller = "../../bd/OrdenPagos/ListarOrdenesPagos.php";// URL   
    ...
    if( region == 0){
        ...
        $("#BancoComunal_name").select2({ 
            placeholder: 'Seleccione un banco comunal',
                ajax: {
                    url: '../../bd/OrdenPagos/BusquedaBancoComunal.php',
                    dataType: 'json',
                    type:'POST',
                    delay: 250,
                    data: function (data) {
    ...
    $("#Anillogrupal_name").select2();
      $("#Anillogrupal_name").select2({ 
          placeholder: 'Seleccione un Anillo Comunal',
            ajax: {
                url: '../../bd/OrdenPagos/BusquedaBancoComunal_anillo.php',
                dataType: 'json',
                type:'POST',
                delay: 250,
                data: function (data) {
